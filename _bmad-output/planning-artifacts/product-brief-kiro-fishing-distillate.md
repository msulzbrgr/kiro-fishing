...
- anglerboard.ch — forum, very low trust
- fischerkarte.ch — permit sales aggregator (medium trust for purchase info, low for law detail)
...
5. aggregator (fischerkarte.ch): MEDIUM
6. news_blog (fischen.ch): LOW
7. forum (anglerboard.ch): VERY LOW
...
- fischerkarte.ch is the closest competitor — focuses on permit sales, not regulation Q&A
